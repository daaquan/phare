...
return [
    ...
    */
    ...
    'emails' => [
        'auth' => [
            'account_confirmed' => 'あなたのアカウントが承認されました。',
            'error' => 'おっと！',
            'greeting' => 'こんにちは！',
            'regards' => 'よろしくお願いします,',
    ...
    'frontend' => [
        ...
        'tests' => [
            ...
            'js_injected_from_controller' => 'コントローラーからJavaScriptが注入されました。',

            'using_blade_extensions' => 'Blade拡張を使用しています。',
