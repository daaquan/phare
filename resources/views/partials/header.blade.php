<div class="items-center flex-none hidden ">
  <a sveltekit:prefetch="" href="/components"
     class="btn btn-ghost drawer-button normal-case">
...
<div title="Change Language" class="dropdown dropdown-end">
  <div tabindex="0" class="btn btn-ghost gap-1 normal-case">
    <svg class="inline-block h-4 w-4 fill-current md:h-5 md:w-5"
  ...
  <div
    ...
    <ul class="menu menu-compact gap-1 p-3" tabindex="0">
      ...
      <li>
        <button class="flex active"><img loading="lazy" width="20" height="20" alt="日本語"
                                         src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.0/svg/1f1ef-1f1f5.svg">
          <span class="flex flex-1 justify-between">日本語 </span></button>
      </li>
      <li>
        <button class="flex"><img loading="lazy" width="20" height="20" alt="한국어"
                                  src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.0/svg/1f1f0-1f1f7.svg">
          <span class="flex flex-1 justify-between">한국어 </span></button>
      </li>
      <li>
      ...
      <li>
        <button class="flex"><img loading="lazy" width="20" height="20" alt="繁體中文"
                                  src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.0/svg/1f1f9-1f1fc.svg">
          <span class="flex flex-1 justify-between">繁體中文 </span></button>
      </li>
    </ul>
  </div>
</div>
<span class="tooltip tooltip-bottom before:text-xs before:content-[attr(data-tip)]"
      data-tip="GitHub"><div class="flex-none items-center"><a aria-label="Github" target="_blank"
                                                               href="https://github.com/saadeghi/daisyui"
                                                               rel="noopener"
                                                               class="btn btn-ghost drawer-button btn-square normal-case"><svg
          width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
          class="inline-block h-5 w-5 fill-current md:h-6 md:w-6"><path
